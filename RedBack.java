 ...
 */
@Autonomous(name="Red Back",group = "Turing League Meet #1")
public class RedBack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            /*gyroDrive(FULL_SPEED, 50, 0);
            gyroTurn(TURN_SPEED, -90);
            gyroHold(TURN_SPEED, -90, 0.5);
            gyroDrive(FULL_SPEED, 10, -90);
            gyroDrive(FULL_SPEED, -5, -90);
            gyroTurn(TURN_SPEED, 0);
            gyroHold(TURN_SPEED, 0, 0.5);
            gyroDrive(FULL_SPEED, -22, 0);
            gyroTurn(TURN_SPEED, 90);
            gyroHold(TURN_SPEED, 90, 0.5);
            gyroDrive(FULL_SPEED, -37, 90);
            gyroTurn(TURN_SPEED, 170);
            gyroHold(TURN_SPEED, 170, 0.5);
            gyroDrive(FULL_SPEED, -7, 170);
            gyroHold(FULL_SPEED,170,0.5);
    ...
    public void move (DcMotor motor, double power, int position)
    {
        ...
        if (opModeIsActive())
        {
            ...
            while (opModeIsActive() && motor.getCurrentPosition() > -180) {
